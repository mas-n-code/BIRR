...
function imafin=Multi_rec(Params)
...
%--------------------------------------------------
ZI = interp2(testgridx,testgridy,I_k_theta_true,kangle,krad,'linear');
[l,m]=find(isnan(ZI));
for a=1:length(l) 
    ZI(l(a),m(a))=0; 
end;
