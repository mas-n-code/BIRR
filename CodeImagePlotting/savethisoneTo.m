...
function savethisoneTo(toPath,Tag,supershort_savetitle)

tic
%%{
supershort_savetitle=[Tag,supershort_savetitle];
% parent_dir=[Tag,'B_Images and Figures'];
% path_tile=[parent_dir,'\',supershort_savetitle,'\'];
mkdir(toPath,supershort_savetitle)
path_tile=[toPath,'\',supershort_savetitle,'\'];
%fig=gcf;
...
% Export opengl and painters
export_fig('-dpng','-transparent','-nocrop','-m2',[path_tile,supershort_savetitle,'opengl']);
export_fig('-png','-transparent','-nocrop','-m2', '-painters',[path_tile,supershort_savetitle,'painters']);
