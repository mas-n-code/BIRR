function ROC_MetaPlotter_LS(Control_ROC,PE,C_Style)
...
yCON=Control_ROC.yroc;
    ...
    ylabel('True positive rate (Sensitivity)','FontName',fName,'FontSize',fSize);
    xlabel('False positive rate (1-Specificity)','FontName',fName,'FontSize',fSize);
    xlim([0 1])
    ylim([0 1])
    axis square
...
plot([0 1],[0 1],'--','LineWidth',1,'Color',[0.1 0.1 0.1]);
    ...
    Le(4).Auc=num2str(PE.E3.ROC.Roc_TumorVsFC.AUC,'%10.3f');
