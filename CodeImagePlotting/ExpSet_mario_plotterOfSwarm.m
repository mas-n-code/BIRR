function ExpSet_mario_plotterOfSwarm(ErrorSet)
%PLOTFIGURE
...
%plot tumor
 ...
 plot(rand(length(e4.CALL.call_tumor),1)*(x_width/2) +i,e4.CALL.call_tumor,'ko','MarkerFaceColor',[0.8 0.2 0.2].^(0.25)); i=i+x_width; plotVL(i)
plot(rand(length(e12.CALL.call_tumor),1)*(x_width/2) +i,e12.CALL.call_tumor,'ko','MarkerFaceColor',[0.8 0.2 0.2].^(0.15)); i=i+x_width; plotVL(i)
...
%plot fibro
 ...
 plot(rand(length(e4.CALL.call_fibro),1)*(x_width/2) +i,e4.CALL.call_fibro,'ko','MarkerFaceColor',[0.1 0.8 0.2].^(0.25)); i=i+x_width; plotVL(i)
plot(rand(length(e12.CALL.call_fibro),1)*(x_width/2) +i,e12.CALL.call_fibro,'ko','MarkerFaceColor',[0.1 0.8 0.2].^(0.15)); i=i+x_width; plotVL(i)
...
plot(rand(length(e4.CALL.call_clutter),1)*(x_width/2) +i,e4.CALL.call_clutter,'ko','MarkerFaceColor',[0.15 0.15 0.8].^(0.25)); i=i+x_width; plotVL(i)
plot(rand(length(e12.CALL.call_clutter),1)*(x_width/2) +i,e12.CALL.call_clutter,'ko','MarkerFaceColor',[0.15 0.15 0.8].^(0.15)); i=i+x_width; 
...
plot([fi fi],[0 6e-9],':','Color',[0.2 0.2 0.2]);
