...
% Saved all files to a dropbox folder:
...
%PHOTOSET directory is probably in 
...
% 
%% Open directory for saved circle-datasets

cd('F:\UserElGuapo\DBOx\Dropbox\ResearchMagic\RandomProyects\2015 HF2\151116 RotAngleAnalysis\FINAL DATASETS\MIM FINAL fThesis');

%% Load circle-datasets and Center datasets

load CircCmplx_RT12.mat
load Center_MIM_RT12.mat
...
savefig(h,'MIM_RotaryStage_Final');