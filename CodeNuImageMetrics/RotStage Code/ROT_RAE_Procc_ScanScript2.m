...
%--------------------------------------------------------------------------
%---------------------mario_ROT_RAE_Procc_ScanScript2-----------------------------
%--------------------------------------------------------------------------
...
%- RAE RAE RAE %% RAE RAE RAE %% RAE RAE RAE %% RAE RAE  %% RAE RAE RAE %-
DTag=['RRAE','_0823_'];
sf1=1;
...
try cd('F:\UserElGuapo\Google Drive\masterSets\RotaryStage\RAE'); %<- Starts with the Single Accuracy Error 5 deg
catch % Lab CPU
end

% Load Scan caracteristics 
try load RAEs_ScansOnly
catch
    load RAEs_wScans
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    RAEs_ScansOnly.PD_P1.E1.SCAN=rmfield(RoRAEs.PD_P1.E1.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P1.E2.SCAN=rmfield(RoRAEs.PD_P1.E2.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P1.E4.SCAN=rmfield(RoRAEs.PD_P1.E4.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P1.E12.SCAN=rmfield(RoRAEs.PD_P1.E12.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P1.GName=RoRAEs.PD_P1.GName;

    RAEs_ScansOnly.PD_P2.E1.SCAN=rmfield(RoRAEs.PD_P2.E1.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P2.E2.SCAN=rmfield(RoRAEs.PD_P2.E2.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P2.E4.SCAN=rmfield(RoRAEs.PD_P2.E4.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P2.E12.SCAN=rmfield(RoRAEs.PD_P2.E12.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P2.GName=RoRAEs.PD_P2.GName;

    RAEs_ScansOnly.PD_P3.E1.SCAN=rmfield(RoRAEs.PD_P3.E1.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P3.E2.SCAN=rmfield(RoRAEs.PD_P3.E2.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P3.E4.SCAN=rmfield(RoRAEs.PD_P3.E4.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P3.E12.SCAN=rmfield(RoRAEs.PD_P3.E12.SCAN,'S11_c_Rec');
    RAEs_ScansOnly.PD_P3.GName=RoRAEs.PD_P3.GName;
    
    save RAEs_ScansOnly RAEs_ScansOnly
    clear RoRAEs
end

% try load RAE_Processed.mat
% catch
% end
...
[PE]=experiment_segmenter_FromTargetMask(RAEs_ScansOnly,sProp);
