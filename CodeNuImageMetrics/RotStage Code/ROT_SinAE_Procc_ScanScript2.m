...
%--------------------------------------------------------------------------
%---------------------mario_ROT_SinAE_Procc_ScanScript2-----------------------------
%--------------------------------------------------------------------------
...
try cd('F:\UserElGuapo\Google Drive\masterSets\RotaryStage\SinAE'); %<- Starts with the Single Accuracy Error 5 deg
catch % Lab CPU
end

% Load Scan caracteristics 
try load SinAEs_ScansOnly
catch
    load SinAEs_wScans
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    SinAEs_ScansOnly.PD_P1.E1.SCAN=rmfield(SinAEs.PD_P1.E1.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P1.E2.SCAN=rmfield(SinAEs.PD_P1.E2.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P1.E4.SCAN=rmfield(SinAEs.PD_P1.E4.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P1.E12.SCAN=rmfield(SinAEs.PD_P1.E12.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P1.GName=SinAEs.PD_P1.GName;

    SinAEs_ScansOnly.PD_P2.E1.SCAN=rmfield(SinAEs.PD_P2.E1.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P2.E2.SCAN=rmfield(SinAEs.PD_P2.E2.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P2.E4.SCAN=rmfield(SinAEs.PD_P2.E4.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P2.E12.SCAN=rmfield(SinAEs.PD_P2.E12.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P2.GName=SinAEs.PD_P2.GName;

    SinAEs_ScansOnly.PD_P3.E1.SCAN=rmfield(SinAEs.PD_P3.E1.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P3.E2.SCAN=rmfield(SinAEs.PD_P3.E2.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P3.E4.SCAN=rmfield(SinAEs.PD_P3.E4.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P3.E12.SCAN=rmfield(SinAEs.PD_P3.E12.SCAN,'S11_c_Rec');
    SinAEs_ScansOnly.PD_P3.GName=SinAEs.PD_P3.GName;
    
    save SinAEs_ScansOnly SinAEs_ScansOnly
    clear SinAEs
end

% try load SinAE_Processed.mat
% catch
% end
...
[PE]=experiment_segmenter_FromTargetMask(SinAEs_ScansOnly,sProp);
