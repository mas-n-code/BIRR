...
call_rest= [ExpSet.P_P1.R_Values.rest; % Note that Call_rest has background information below threshold level, but it shall not contain target info
            ExpSet.P_P2.R_Values.rest; % Note also that rest contains clutter! there is no region which contains ONLY below threshold pixels
            ExpSet.P_P3.R_Values.rest];
