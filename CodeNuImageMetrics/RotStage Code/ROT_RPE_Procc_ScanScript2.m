...
%--------------------------------------------------------------------------
%---------------------mario_ROT_RPE_Procc_ScanScript2-----------------------------
%--------------------------------------------------------------------------
...
%- RPE RPE RPE %% RPE RPE RPE %% RPE RPE RPE %% RPE RPE  %% RPE RPE RPE %-
DTag=['RRPE','_0823_'];
sf1=1;
...
try cd('F:\UserElGuapo\Google Drive\masterSets\RotaryStage\RPE'); %<- Starts with the Single Accuracy Error 5 deg
catch % Lab CPU
end

% Load Scan caracteristics 
try load RPEs_ScansOnly
catch
    load RPEs_wScans
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    RPEs_ScansOnly.PD_P1.E1.SCAN=rmfield(RoRPEs.PD_P1.E1.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P1.E2.SCAN=rmfield(RoRPEs.PD_P1.E2.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P1.E4.SCAN=rmfield(RoRPEs.PD_P1.E4.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P1.E12.SCAN=rmfield(RoRPEs.PD_P1.E12.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P1.GName=RoRPEs.PD_P1.GName;

    RPEs_ScansOnly.PD_P2.E1.SCAN=rmfield(RoRPEs.PD_P2.E1.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P2.E2.SCAN=rmfield(RoRPEs.PD_P2.E2.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P2.E4.SCAN=rmfield(RoRPEs.PD_P2.E4.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P2.E12.SCAN=rmfield(RoRPEs.PD_P2.E12.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P2.GName=RoRPEs.PD_P2.GName;

    RPEs_ScansOnly.PD_P3.E1.SCAN=rmfield(RoRPEs.PD_P3.E1.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P3.E2.SCAN=rmfield(RoRPEs.PD_P3.E2.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P3.E4.SCAN=rmfield(RoRPEs.PD_P3.E4.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P3.E12.SCAN=rmfield(RoRPEs.PD_P3.E12.SCAN,'S11_c_Rec');
    RPEs_ScansOnly.PD_P3.GName=RoRPEs.PD_P3.GName;
    
    save RPEs_ScansOnly RPEs_ScansOnly
    clear RoRPEs
end

% try load RPE_Processed.mat
% catch
% end
...
[PE]=experiment_segmenter_FromTargetMask(RPEs_ScansOnly,sProp);
