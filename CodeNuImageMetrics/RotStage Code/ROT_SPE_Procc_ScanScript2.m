...
%--------------------------------------------------------------------------
%---------------------mario_ROT_SPE_Procc_ScanScript2-----------------------------
%--------------------------------------------------------------------------
...
try cd('F:\UserElGuapo\Google Drive\masterSets\RotaryStage\SPE'); %<- Starts with the Single Accuracy Error 5 deg
catch % Lab CPU
end
...
try load SPEs_ScansOnly
catch
    load SPEs_wScans
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    SPEs_ScansOnly.PD_P1.E1.SCAN=rmfield(SPEs.PD_P1.E1.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P1.E2.SCAN=rmfield(SPEs.PD_P1.E2.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P1.E4.SCAN=rmfield(SPEs.PD_P1.E4.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P1.E12.SCAN=rmfield(SPEs.PD_P1.E12.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P1.GName=SPEs.PD_P1.GName;

    SPEs_ScansOnly.PD_P2.E1.SCAN=rmfield(SPEs.PD_P2.E1.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P2.E2.SCAN=rmfield(SPEs.PD_P2.E2.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P2.E4.SCAN=rmfield(SPEs.PD_P2.E4.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P2.E12.SCAN=rmfield(SPEs.PD_P2.E12.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P2.GName=SPEs.PD_P2.GName;

    SPEs_ScansOnly.PD_P3.E1.SCAN=rmfield(SPEs.PD_P3.E1.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P3.E2.SCAN=rmfield(SPEs.PD_P3.E2.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P3.E4.SCAN=rmfield(SPEs.PD_P3.E4.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P3.E12.SCAN=rmfield(SPEs.PD_P3.E12.SCAN,'S11_c_Rec');
    SPEs_ScansOnly.PD_P3.GName=SPEs.PD_P3.GName;
    
    save SPEs_ScansOnly SPEs_ScansOnly
    clear SPEs
end

% try load SPE_Processed.mat
% catch
% end
...
[PE]=experiment_segmenter_FromTargetMask(SPEs_ScansOnly,sProp);
