...
%--------------------------------------------------------------------------
%---------------------mario_ROT_CPE_Procc_ScanScript2-----------------------------
%--------------------------------------------------------------------------
...
try cd('F:\UserElGuapo\Google Drive\masterSets\RotaryStage\CPE'); %<- Starts with the Single Accuracy Error 5 deg
catch % Lab CPU
end
...
try load CPEs_ScansOnly
catch
    load CPEs_wScans
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    CPEs_ScansOnly.PD_P1.E1.SCAN=rmfield(CPEs.PD_P1.E1.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P1.E2.SCAN=rmfield(CPEs.PD_P1.E2.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P1.E4.SCAN=rmfield(CPEs.PD_P1.E4.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P1.E12.SCAN=rmfield(CPEs.PD_P1.E12.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P1.GName=CPEs.PD_P1.GName;

    CPEs_ScansOnly.PD_P2.E1.SCAN=rmfield(CPEs.PD_P2.E1.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P2.E2.SCAN=rmfield(CPEs.PD_P2.E2.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P2.E4.SCAN=rmfield(CPEs.PD_P2.E4.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P2.E12.SCAN=rmfield(CPEs.PD_P2.E12.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P2.GName=CPEs.PD_P2.GName;

    CPEs_ScansOnly.PD_P3.E1.SCAN=rmfield(CPEs.PD_P3.E1.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P3.E2.SCAN=rmfield(CPEs.PD_P3.E2.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P3.E4.SCAN=rmfield(CPEs.PD_P3.E4.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P3.E12.SCAN=rmfield(CPEs.PD_P3.E12.SCAN,'S11_c_Rec');
    CPEs_ScansOnly.PD_P3.GName=CPEs.PD_P3.GName;
    
    save CPEs_ScansOnly CPEs_ScansOnly
    clear CPEs
end
...
[PE]=experiment_segmenter_FromTargetMask(CPEs_ScansOnly,sProp);
