...
%--------------------------------------------------------------------------
%---------------------mario_ROT_SAE_Procc_ScanScript2-----------------------------
%--------------------------------------------------------------------------
...
try load SAEs_ScansOnly
catch
    load SAEs_wScans
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    SAEs_ScansOnly.PD_P1.E1.SCAN=rmfield(SAEs.PD_P1.E1.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P1.E2.SCAN=rmfield(SAEs.PD_P1.E2.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P1.E4.SCAN=rmfield(SAEs.PD_P1.E4.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P1.E12.SCAN=rmfield(SAEs.PD_P1.E12.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P1.GName=SAEs.PD_P1.GName;

    SAEs_ScansOnly.PD_P2.E1.SCAN=rmfield(SAEs.PD_P2.E1.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P2.E2.SCAN=rmfield(SAEs.PD_P2.E2.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P2.E4.SCAN=rmfield(SAEs.PD_P2.E4.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P2.E12.SCAN=rmfield(SAEs.PD_P2.E12.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P2.GName=SAEs.PD_P2.GName;

    SAEs_ScansOnly.PD_P3.E1.SCAN=rmfield(SAEs.PD_P3.E1.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P3.E2.SCAN=rmfield(SAEs.PD_P3.E2.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P3.E4.SCAN=rmfield(SAEs.PD_P3.E4.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P3.E12.SCAN=rmfield(SAEs.PD_P3.E12.SCAN,'S11_c_Rec');
    SAEs_ScansOnly.PD_P3.GName=SAEs.PD_P3.GName;
    
    save SAEs_ScansOnly SAEs_ScansOnly
    clear SAEs
end

% try load SAE_Processed.mat
% catch
% end
...
[PE]=experiment_segmenter_FromTargetMask(SAEs_ScansOnly,sProp);
