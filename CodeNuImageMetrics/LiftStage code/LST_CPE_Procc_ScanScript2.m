...
try cd('F:\UserElGuapo\Google Drive\masterSets\LiftStage\1 Top\LST CPE');
catch % Lab CPU
    try
    cd('G:\Google Drive\masterSets\LiftStage\3 Bottom\TSB CPE')
    catch
        disp('-!nope');
    end
end
...
try load TSBCPE_ScansOnly
catch
    load 'LS_Top_CPEs.mat'
     % might be worth to use -> exist to chect what the name of variable
     % remains as wScans
    TSBCPE_ScansOnly.PD_P1.E1.SCAN=rmfield(LS_T_CPEs.PD_P1.E1.SCAN,'S11_c_Rec');
    TSBCPE_ScansOnly.PD_P1.E2.SCAN=rmfield(LS_T_CPEs.PD_P1.E2.SCAN,'S11_c_Rec');
    TSBCPE_ScansOnly.PD_P1.E3.SCAN=rmfield(LS_T_CPEs.PD_P1.E3.SCAN,'S11_c_Rec');
    TSBCPE_ScansOnly.PD_P1.GName=LS_T_CPEs.PD_P1.GName;

    TSBCPE_ScansOnly.PD_P2.E1.SCAN=rmfield(LS_T_CPEs.PD_P2.E1.SCAN,'S11_c_Rec');
    TSBCPE_ScansOnly.PD_P2.E2.SCAN=rmfield(LS_T_CPEs.PD_P2.E2.SCAN,'S11_c_Rec');
    TSBCPE_ScansOnly.PD_P2.E3.SCAN=rmfield(LS_T_CPEs.PD_P2.E3.SCAN,'S11_c_Rec');
    TSBCPE_ScansOnly.PD_P2.GName=LS_T_CPEs.PD_P2.GName;

    save TSBCPE_ScansOnly TSBCPE_ScansOnly
    clear LS_Top_CPEs
end
...
[PE]=experiment_segmenter_FromTargetMask_LS(TSBCPE_ScansOnly,LsProp);
...
% Generate plot
 ROC_MetaPlotter_LS(Control_ROC,PE,'Strong')
