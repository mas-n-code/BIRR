...
f_variables='F:\UserElGuapo\DBOx\Dropbox\ResearchMagic\RandomProyects\160110 12 Effects of AR\MASTER Dataset LiftStage\2 Middle\Control Scans';
...
cd(f_rawData)
load MiddleRegion_Control_LEAN
...
cd([f_rawData,'\Middle\ML0'])
Ref_files = dir('**Mono*[A]***.txt');
TumorFibro_files=dir('*Mono*[C]***.txt');
Tumor_files = dir('**Mono*[B]***.txt');

LSSet_M.L0.P1.set_ref=load(Ref_files(1).name);
LSSet_M.L0.P1.set_data=load(TumorFibro_files(1).name);
LSSet_M.L0.P1.set_tumor=load(Tumor_files(1).name);

LSSet_M.L0.P2.set_ref=load(Ref_files(2).name);
LSSet_M.L0.P2.set_data=load(TumorFibro_files(2).name);
LSSet_M.L0.P2.set_tumor=load(Tumor_files(2).name);


cd(f_masterSets)

save MiddleRegion_Control LSSet_M
%}

%}
%% Load variables if required
load('F:\UserElGuapo\Google Drive\masterSets\LiftStage\2 Middle\MiddleRegion_Control.mat')
...
RecSettings.Arrasize=size(LSSet_M.L0.P1.set_ref,2)/2;
LSSet_M.RecSettings=RecSettings; 


%% Reconstruct Middle Control C
...
supershort='P1 LS Middle [C] Control';
a_Target=LSSet_M.L0.P1.set_data;
a_Reference=LSSet_M.L0.P1.set_ref;
[LSSet_M.L0.P1.C_Scan]=...
...
supershort='P2 LS Middle [C] Control';
a_Target=LSSet_M.L0.P2.set_data;
a_Reference=LSSet_M.L0.P2.set_ref;
[LSSet_M.L0.P2.C_Scan]=...
    monofun_mario_cmS(a_Reference,a_Target,RecSettings,supershort);
...
supershort='P1 LS Middle [B] Control';
a_Target=LSSet_M.L0.P1.set_tumor;
a_Reference=LSSet_M.L0.P1.set_ref;
[LSSet_M.L0.P1.TumorScan]=...
    monofun_mario_cmS(a_Reference,a_Target,RecSettings,supershort);

%CC Combo
RecSettings.counterWise=0;RecSettings.wflip=1;

supershort='P2 LS Middle [B] Control';
a_Target=LSSet_M.L0.P2.set_tumor;
a_Reference=LSSet_M.L0.P2.set_ref;
[LSSet_M.L0.P2.TumorScan]=...
    monofun_mario_cmS(a_Reference,a_Target,RecSettings,supershort);
...
ImageControl1=abs(LSSet_M.L0.P1.C_Scan.S11_c_RecZoomFlip);
ImageControl2=abs(LSSet_M.L0.P2.C_Scan.S11_c_RecZoomFlip);
ImageTumor=abs(LSSet_M.L0.P1.TumorScan.S11_c_RecZoomFlip);
...
LSSet_M.Regions=Regions;

cd(f_variables); save LS_T_RegionsControlScan Regions
cd(f_masterSets); save MiddleRegion_Control LSSet_M
...
regions_show(ImageControl1,ImageControl2,LSSet_M.Regions,codeName1,codeName2,IM_Clim);


cd([f_variables,'\B_Regions'])

savethisone('RegionsOfSegmentation_Control1and2')

%% 3 Calculate metrics based on regions

LSSet_M.L0.P1.ImageMetrics.Name= 'C-Scan Control P1';
LSSet_M.L0.P2.ImageMetrics.Name= 'C-Scan Control P2';
LSSet_M.L0.P1.PowImageMetrics.Name= 'C-Scan Control P1 Power';
LSSet_M.L0.P2.PowImageMetrics.Name= 'C-Scan Control P2 Power';
...
[LSSet_M.L0.P1.ImageMetrics]=I_RegionStandard(ImageControl1,Regions,LSSet_M.L0.P1.ImageMetrics,tresh_magnitude); 
savethisone('Control P1 magnitude structure mean')

% Calculate values of regions in control scan 2
[LSSet_M.L0.P2.ImageMetrics]=I_RegionStandard(ImageControl2,Regions,LSSet_M.L0.P2.ImageMetrics,tresh_magnitude); 
savethisone('Control P2 magnitude structure mean')

% Calculate values of regions in control scan 1 POWER
[LSSet_M.L0.P1.PowImageMetrics]=I_RegionStandard(ImageControl1.^2,Regions,LSSet_M.L0.P1.PowImageMetrics,IP_Clim); 
savethisone('Control P1 power structure mean')

% Calculate values of regions in control scan 2 POWER
[LSSet_M.L0.P2.PowImageMetrics]=I_RegionStandard(ImageControl2.^2,Regions,LSSet_M.L0.P2.PowImageMetrics,IP_Clim); 
...
figure;imagesc(refAverageImage.Image); colorbar; axis('square');savethisone('AverageControlImage')
refAverageImage.PowMetrics.Name='RefImageAverageControl';
...
[LSSet_M.L0.P1.PowImageMetrics]=IQ_Standard(ImageControl1.^2,refAverageImage.Image,LSSet_M.L0.P1.PowImageMetrics,refAverageImage.PowMetrics); 
savethisone([LSSet_M.L0.P1.PowImageMetrics.Name 'SSIM vs Average POw']);% Same, just saved in both Metric Files

[LSSet_M.L0.P2.PowImageMetrics]=IQ_Standard(ImageControl2.^2,refAverageImage.Image,LSSet_M.L0.P2.PowImageMetrics,refAverageImage.PowMetrics); 
savethisone([LSSet_M.L0.P2.PowImageMetrics.Name 'SSIM vs Average POw']);% Same, just saved in both Metric Files


cd(f_masterSets); save MiddleRegion_Control LSSet_M;

%% 3.d Calculate radar image quality metrics [based on magnitude, of course]
[LSSet_M.L0.P1.ImageMetrics]=I_ScR(LSSet_M.L0.P1.ImageMetrics);  
[LSSet_M.L0.P1.ImageMetrics]=I_TfR(LSSet_M.L0.P1.ImageMetrics);
[LSSet_M.L0.P1.ImageMetrics]=I_CtfCR(LSSet_M.L0.P1.ImageMetrics); 

[LSSet_M.L0.P2.ImageMetrics]=I_ScR(LSSet_M.L0.P2.ImageMetrics);  
[LSSet_M.L0.P2.ImageMetrics]=I_TfR(LSSet_M.L0.P2.ImageMetrics);
[LSSet_M.L0.P2.ImageMetrics]=I_CtfCR(LSSet_M.L0.P2.ImageMetrics); 
...
close all;
[LSSet_M.L0.P1] = spatialPos(LSSet_M.L0.P1,ImageControl1);
[LSSet_M.L0.P2] = spatialPos(LSSet_M.L0.P2,ImageControl2);
...
% Generate eSummary 
[LSSet_M.L0.P1]=eSummaryMaker(LSSet_M.L0.P1);
[LSSet_M.L0.P2]=eSummaryMaker(LSSet_M.L0.P2);
cd(f_masterSets); save MiddleRegion_Control LSSet_M;

% Export such eSummary
cd([f_variables,'\E_ExcelFiles']) 
estructExceler(LSSet_M.L0.P1.ImageMetrics.eSummary,[LSSet_M.L0.P1.ImageMetrics.Name,'eSummary']);
estructExceler(LSSet_M.L0.P2.ImageMetrics.eSummary,[LSSet_M.L0.P2.ImageMetrics.Name,'eSummary']);


%% LEAN
removeFields={'set_ref','set_data','set_tumor','C_Scan','TumorScan'};
LSSet_M_LEAN=LSSet_M;
LSSet_M_LEAN.L0.P1=rmfield(LSSet_M.L0.P1,removeFields);
LSSet_M_LEAN.L0.P2=rmfield(LSSet_M.L0.P2,removeFields);
cd(f_variables);
save MiddleRegion_Control_LEAN LSSet_M_LEAN;

%% UNDERWORK  5 Create plots that have IQM as controls. UNDERWORK

[LScontrolSummaryError]=ContolSet_table(LSSet_M_LEAN.L0);
LSSet_M_LEAN.L0Summary.GroupTable=LScontrolSummaryError.GroupTable;
LSSet_M_LEAN.L0Summary.table2exp=LScontrolSummaryError.table3exp;
LOsummary=LSSet_M_LEAN.L0Summary;
