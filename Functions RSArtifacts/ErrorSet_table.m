function [errorSet]=ErrorSet_table(errorSet)
...
Tumor_Mean_M= [errorSet.PD_P1.GeSummary.TumorMean;errorSet.PD_P2.GeSummary.TumorMean;errorSet.PD_P3.GeSummary.TumorMean];
Fibro_Mean_M= [errorSet.PD_P1.GeSummary.FibroMean;errorSet.PD_P2.GeSummary.FibroMean;errorSet.PD_P3.GeSummary.FibroMean];
Back_Mean_M= [errorSet.PD_P1.GeSummary.BackMean;errorSet.PD_P2.GeSummary.BackMean;errorSet.PD_P3.GeSummary.BackMean];



% tumor uncertainty matrix
Tumor_Std_M= [errorSet.PD_P1.GeSummary.TumorStd;errorSet.PD_P2.GeSummary.TumorStd;errorSet.PD_P3.GeSummary.TumorStd];
Fibro_Std_M= [errorSet.PD_P1.GeSummary.FibroStd;errorSet.PD_P2.GeSummary.FibroStd;errorSet.PD_P3.GeSummary.FibroStd];
Back_Std_M= [errorSet.PD_P1.GeSummary.BackStd;errorSet.PD_P2.GeSummary.BackStd;errorSet.PD_P3.GeSummary.BackStd];
...
table_sum=table([Experiment_Name(1)],... %([Experiment_Name(1);Experiment_Name(2);Experiment_Name(3);Experiment_Name(4)],...
    wTumor_Mean_Mat,...
    wFibro_Mean_Mat,...
    wBack_Mean_Mat,...
    wTumor_Unc_Mat,...
...
errorSet.ByErr.E2=...
    ...
    errorSet.PD_P3.GeSummary(2,:),...
    ];

errorSet.ByErr.E4=...
    [...
    errorSet.PD_P1.GeSummary(3,:),...
    errorSet.PD_P2.GeSummary(3,:),...
    errorSet.PD_P3.GeSummary(3,:),...
    ];

errorSet.ByErr.E12=...
    [...
    errorSet.PD_P1.GeSummary(4,:),...
    errorSet.PD_P2.GeSummary(4,:),...
    errorSet.PD_P3.GeSummary(4,:),...
    ];
