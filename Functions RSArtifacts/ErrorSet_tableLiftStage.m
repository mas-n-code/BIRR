function [errorSet]=ErrorSet_tableLiftStage(errorSet)
...
table_sum=table([Experiment_Name(1);Experiment_Name(2);Experiment_Name(3)],...
    wTumor_Mean_Mat,...
    wFibro_Mean_Mat,...
    wBack_Mean_Mat,...
    wTumor_Unc_Mat,...
